...
while True:
    ...
    cv2.circle(color_data, (center[0],int(center[1]+(45*scale))), 2, (0, 255, 0), 2)  # outer circle
    cv2.circle(color_data, (center[0],int(center[1]+(135*scale))), 2, (0, 0, 255), 2)
    cv2.circle(color_data, (center[0],int(center[1]+(225*scale))), 2, (255, 0, 0), 3)  # center
